...
use rustfetch::{
    cpu::get_styled_cpu, de::get_styled_de, get_styled_line, kernel::get_styled_kernel,
    memory::get_styled_memory, name::get_styled_name, os::get_styled_os, shell::get_styled_shell,
    wm::get_styled_wm,
};
...
fn main() {
    ...
    print_styled_text(&mut out, &styled_cpu.styles, padding).unwrap();
